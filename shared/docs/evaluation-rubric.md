# Assessment rubric (shared)

This rubric is the **common scoring standard** for every evaluation service.
When a new service is designed, capabilities are classified into pillars and you confirm: 
