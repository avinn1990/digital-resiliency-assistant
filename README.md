...
| Topic | Detail |
|-------|--------|
| **Framework uploads** | `dra-framework` uses the Render **Standard** plan with a persistent disk at `data/` so uploads survive deploys. Other services remain on the free tier. |
